...
export const channelCreateEvent = (t: ChannelCreateEventTemplate, privateKey: string): Event<Kind.ChannelCreation> | undefined => {
  let content: string;
...
export const channelMetadataEvent = (t: ChannelMetadataEventTemplate, privateKey: string): Event<Kind.ChannelMetadata> | undefined => {
  let content: string;
  if (typeof(t.content) === 'object') {
    content = JSON.stringify(t.content)
  } else if (typeof(t.content) === 'string') {
...
export const channelHideMessageEvent = (t: ChannelHideMessageEventTemplate, privateKey: string): Event<Kind.ChannelHideMessage> | undefined => {
  let content: string;
  if (typeof(t.content) === 'object') {
    content = JSON.stringify(t.content)
  } else if (typeof(t.content) === 'string') {
...
export const channelMuteUserEvent = (t: ChannelMuteUserEventTemplate, privateKey: string): Event<Kind.ChannelMuteUser> | undefined => {
  let content: string;
  if (typeof(t.content) === 'object') {
    content = JSON.stringify(t.content)
  } else if (typeof(t.content) === 'string') {
